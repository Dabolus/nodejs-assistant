...
import { ClientDuplexStream, loadPackageDefinition, ChannelCredentials } from 'grpc';
import protoFiles from 'google-proto-files';

export namespace EmbeddedAssistantPb {
...
export const embeddedAssistantPbPromise: Promise<EmbeddedAssistantPb.EmbeddedAssistant> =
